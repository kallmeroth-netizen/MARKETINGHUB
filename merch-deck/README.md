...
Every product on the comp slides and the two confirmed Neighborly pieces are flat
vector renderings, generated by `product-art.py` from the reference shots. They are
obviously illustrations rather than photos, and every name and price beside them is
accurate. Swap in real photography whenever the files are available.
