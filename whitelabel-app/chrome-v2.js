...
(function () {
  ...
  var HUB_ITEMS = [
    ...
    { key:'pmix',     label:'Sales & Pmix',          sub:'Daily sales & product mix', href:'coming-soon.html?m=pmix',     bg:'#e3ece3', stroke:'#5a7a5a', roles:['team','guest','admin'],
      svg:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 20V10M10 20V4M16 20v-7M22 20H2"/></svg>' },
    { key:'calendar', label:'Marketing Calendar',    sub:'Campaigns & scheduling',    href:'coming-soon.html?m=calendar', bg:'#e4f5ea', stroke:'#7bbd91', roles:['team','guest','admin'],
    ...
    { key:'assets',   label:'Brand Assets',          sub:'Logos & templates',         href:'coming-soon.html?m=assets',   bg:'#f7f0e4', stroke:'#9c7a3c', roles:['team','guest','admin'],
    ...
    { key:'guests',   label:'Guest Intelligence',    sub:'Feedback & experience',     href:'coming-soon.html?m=guests',   bg:'#f0eff5', stroke:'#5a4a7a', roles:['team','admin'],
