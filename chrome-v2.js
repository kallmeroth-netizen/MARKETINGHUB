...
(function () {
  ...
  const HUB_ITEMS = [
    ...
    { key:'orders',      label:'Order Operations',      sub:'Kitchen & delivery flow',       href:'neighborly-orders.html',      bg:'#fdeee7', stroke:'#a32d2d', roles:['team','ops','admin'],
      svg:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z"/><path d="M3 6h18"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>' },
    { key:'reorders',    label:'Supply Reorders',       sub:'Stickers & merch re-ordering',  href:'neighborly-stickers.html',    bg:'#f4e3e6', stroke:'#7a2233', roles:['team','ops','admin'],
      svg:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.59 13.41 13.42 20.6a2 2 0 0 1-2.83 0L3 13V3h10l7.59 7.59a2 2 0 0 1 0 2.82Z"/><circle cx="7.5" cy="7.5" r="1.2"/></svg>' },
